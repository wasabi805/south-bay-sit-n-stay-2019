...
import CalendarModalPresenter from "../Modals/calendar-modal-container";
...
class BookingSection extends Component {
  ...
  handleNext = e => {
    let { isSubmit, isErrors } = this.state;
    ...
    if(id === "next-02" ){
      ...
      this.props.validateForm(this.state.contactForm);
    }
